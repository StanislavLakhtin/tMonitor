...
// original was "44":[0,0,0,0,6,4,2,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_44={3, {0x00,0x50,0x30}}; // ,
...
// original was "97":[0,0,14,16,28,18,18,44,0,0,0,0,0,0,0,0
const Ks0108Char_t char_97={6, {0x00,0x64,0x94,0x94,0x78,0x80}}; // a

// original was "98":[0,2,14,18,18,18,18,14,0,0,0,0,0,0,0,0
const Ks0108Char_t char_98={5, {0x00,0xfe,0x84,0x84,0x78}}; // b

// original was "99":[0,0,12,18,2,2,18,12,0,0,0,0,0,0,0,0
const Ks0108Char_t char_99={5, {0x00,0x78,0x84,0x84,0x48}}; // c

// original was "100":[0,16,28,18,18,18,18,28,0,0,0,0,0,0,0,0
const Ks0108Char_t char_100={5, {0x00,0x78,0x84,0x84,0xfe}}; // d

// original was "101":[0,0,12,18,18,30,2,12,0,0,0,0,0,0,0,0
const Ks0108Char_t char_101={5, {0x00,0x78,0xa4,0xa4,0x38}}; // e

// original was "102":[0,8,20,4,14,4,4,4,0,0,0,0,0,0,0,0
const Ks0108Char_t char_102={5, {0x00,0x10,0xfc,0x12,0x04}}; // f

// original was "103":[0,12,18,18,18,28,16,12,0,0,0,0,0,0,0,0
const Ks0108Char_t char_103={5, {0x00,0x1c,0xa2,0xa2,0x7c}}; // g

// original was "104":[0,2,2,14,18,18,18,18,0,0,0,0,0,0,0,0
const Ks0108Char_t char_104={5, {0x00,0xfe,0x08,0x08,0xf0}}; // h

// original was "105":[0,2,0,2,2,2,2,2,0,0,0,0,0,0,0,0
const Ks0108Char_t char_105={2, {0x00,0xfa}}; // i

// original was "106":[0,4,0,4,4,4,4,2,0,0,0,0,0,0,0,0
const Ks0108Char_t char_106={3, {0x00,0x80,0x7a}}; // j

// original was "107":[0,2,2,18,10,6,10,18,0,0,0,0,0,0,0,0
const Ks0108Char_t char_107={5, {0x00,0xfe,0x20,0x50,0x88}}; // k

// original was "108":[0,2,2,2,2,2,2,2,0,0,0,0,0,0,0,0
const Ks0108Char_t char_108={2, {0x00,0xfe}}; // l

// original was "109":[0,0,22,42,42,42,42,42,0,0,0,0,0,0,0,0
const Ks0108Char_t char_109={6, {0x00,0xfc,0x04,0xf8,0x04,0xf8}}; // m

// original was "110":[0,0,14,18,18,18,18,18,0,0,0,0,0,0,0,0
const Ks0108Char_t char_110={5, {0x00,0xfc,0x04,0x04,0xf8}}; // n

// original was "111":[0,0,12,18,18,18,18,12,0,0,0,0,0,0,0,0
const Ks0108Char_t char_111={5, {0x00,0x78,0x84,0x84,0x78}}; // o

// original was "112":[0,14,18,18,18,18,14,2,0,0,0,0,0,0,0,0
const Ks0108Char_t char_112={5, {0x00,0xfe,0x42,0x42,0x3c}}; // p

// original was "113":[0,28,18,18,18,18,28,16,0,0,0,0,0,0,0,0
const Ks0108Char_t char_113={5, {0x00,0x3c,0x42,0x42,0xfe}}; // q

// original was "114":[0,0,10,22,2,2,2,2,0,0,0,0,0,0,0,0
const Ks0108Char_t char_114={5, {0x00,0xfc,0x08,0x04,0x08}}; // r

// original was "115":[0,0,28,2,12,16,16,14,0,0,0,0,0,0,0,0
const Ks0108Char_t char_115={5, {0x00,0x88,0x94,0x94,0x64}}; // s

// original was "116":[0,4,14,4,4,4,4,24,0,0,0,0,0,0,0,0
const Ks0108Char_t char_116={5, {0x00,0x04,0x7e,0x84,0x80}}; // t

// original was "117":[0,0,18,18,18,18,18,28,0,0,0,0,0,0,0,0
const Ks0108Char_t char_117={5, {0x00,0x7c,0x80,0x80,0xfc}}; // u

// original was "118":[0,0,34,34,20,28,8,8,0,0,0,0,0,0,0,0
const Ks0108Char_t char_118={6, {0x00,0x0c,0x30,0xe0,0x30,0x0c}}; // v

// original was "119":[0,0,130,130,84,124,40,40,0,0,0,0,0,0,0,0
const Ks0108Char_t char_119={8, {0x00,0x0c,0x30,0xe0,0x30,0xe0,0x30,0x0c}}; // w

// original was "120":[0,0,34,34,20,28,34,34,0,0,0,0,0,0,0,0
const Ks0108Char_t char_120={6, {0x00,0xcc,0x30,0x20,0x30,0xcc}}; // x

// original was "121":[0,0,18,18,20,24,16,12,0,0,0,0,0,0,0,0
const Ks0108Char_t char_121={5, {0x00,0x0c,0x90,0xa0,0x7c}}; // y

// original was "122":[0,0,30,16,8,4,2,30,0,0,0,0,0,0,0,0
const Ks0108Char_t char_122={5, {0x00,0xc4,0xa4,0x94,0x8c}}; // z
...
// original was "1072":[0,0,28,32,60,34,92,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1072={7, {0x00,0x20,0x54,0x54,0x54,0x38,0x40}}; // а

// original was "1073":[0,62,4,8,30,34,28,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1073={6, {0x00,0x32,0x56,0x5a,0x52,0x22}}; // б

// original was "1074":[0,0,14,18,30,34,30,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1074={6, {0x00,0x7c,0x54,0x54,0x58,0x20}}; // в

// original was "1075":[0,14,2,2,2,2,2,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1075={4, {0x00,0x7e,0x02,0x02}}; // г

// original was "1076":[0,0,0,56,36,36,126,66,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1076={7, {0x00,0xc0,0x70,0x48,0x48,0x78,0xc0}}; // д

// original was "1077":[0,0,28,34,30,2,28,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1077={6, {0x00,0x38,0x54,0x54,0x54,0x08}}; // е

// original was "1078":[0,42,42,42,42,28,42,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1078={6, {0x00,0x5e,0x20,0x7e,0x20,0x5e}}; // ж

// original was "1079":[0,28,32,28,32,34,28,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1079={6, {0x00,0x20,0x4a,0x4a,0x4a,0x34}}; // з

// original was "1080":[0,0,34,50,42,38,34,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1080={6, {0x00,0x7c,0x20,0x10,0x08,0x7c}}; // и

// original was "1081":[0,8,42,50,42,38,34,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1081={6, {0x00,0x7c,0x20,0x16,0x08,0x7c}}; // й
...
const Ks0108Char_t char_1085={5, {0x00,0x7c,0x10,0x10,0x7c}}; // н

// original was "1086":[0,0,12,18,18,18,12,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1086={5, {0x00,0x38,0x44,0x44,0x38}}; // о

// original was "1087":[0,0,30,18,18,18,18,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1087={5, {0x00,0x7c,0x04,0x04,0x7c}}; // п

// original was "1088":[0,0,14,18,18,18,14,2,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1088={5, {0x00,0xfc,0x44,0x44,0x38}}; // р

// original was "1089":[0,0,28,2,2,2,28,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1089={5, {0x00,0x38,0x44,0x44,0x44}}; // с
...
// original was "1093":[0,0,34,20,8,20,34,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1093={6, {0x00,0x44,0x28,0x10,0x28,0x44}}; // х

// original was "1094":[0,0,18,18,18,18,62,32,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1094={6, {0x00,0x7c,0x40,0x40,0x7c,0xc0}}; // ц

// original was "1095":[0,0,18,18,18,28,16,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1095={5, {0x00,0x1c,0x20,0x20,0x7c}}; // ч
...
const Ks0108Char_t char_1098={6, {0x00,0x04,0x7c,0x48,0x48,0x30}}; // ъ

// original was "1100":[0,0,2,14,18,18,14,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1100={5, {0x00,0x7c,0x48,0x48,0x30}}; // ь

// original was "1101":[0,0,14,16,30,16,14,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1101={5, {0x00,0x54,0x54,0x54,0x38}}; // э

// original was "1102":[0,0,50,74,78,74,50,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1102={7, {0x00,0x7c,0x10,0x38,0x44,0x44,0x38}}; // ю

// original was "1103":[0,0,28,18,18,28,18,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1103={5, {0x00,0x58,0x24,0x24,0x7c}}; // я

// original was "1105":[20,0,28,34,30,2,28,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1105={6, {0x00,0x38,0x55,0x54,0x55,0x08}}; // ё
...
const uint16_t charTable[] = {
        ...
        1057,1058,1060,1061,// С, Т, Ф, Х,
        1062,1063,1064,1065,// Ц, Ч, Ш, Щ,
        1066,1068,1069,1070,// Ъ, Ь, Э, Ю,
        1071,1072,1073,1074,// Я, а, б, в,
        1075,1076,1077,1078,// г, д, е, ж,
        1079,1080,1081,1082,// з, и, й, к,
        1083,1084,1085,1086,// л, м, н, о,
        1087,1088,1089,1090,// п, р, с, т,
        1092,1093,1094,1095,// ф, х, ц, ч,
